...
class GooeyAnimationWidget extends StatefulWidget{
  ...
  @override
  _GooeyAnimationState createState() => _GooeyAnimationState();
}

class _GooeyAnimationState extends State<GooeyAnimationWidget> with SingleTickerProviderStateMixin {
        ...
        child: Stack(children: <Widget>[
          Transform(
            ...
            child: Transform.translate(
              ...
              child: Image.asset('images/Bg-Red.png', fit: BoxFit.cover, package: ListApp.pkg),
            ),
          ),

          _dragIndex == null ? SizedBox() : ClipPath(
            child: Image.asset('images/Bg-Blue.png', fit: BoxFit.cover, package: ListApp.pkg),
