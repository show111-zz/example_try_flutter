...
void main() => runApp(RectExample());

class RectExample extends StatelessWidget{

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Example rect',
      home: RectsExamplePage(),
    );
  }
}


class RectsExamplePage extends StatefulWidget {
  @override
  _RectsExampleState createState() => _RectsExampleState();
}

class _RectsExampleState extends State<RectsExamplePage> {
  int _index = -1;
